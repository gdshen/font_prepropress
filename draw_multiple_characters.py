...
if __name__ == '__main__':
    ...
    parser.add_argument('--font_size', type=int, default=64, help="the size of the font")
    parser.add_argument('--canvas_size', type=int, default=64, help='the size of canvas')
